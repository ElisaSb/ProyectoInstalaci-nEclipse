...
public class TestTrianguloRectangulo {
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, t, "Triangulo Rectángulo", JOptionPane.INFORMATION_MESSAGE);
		JOptionPane.showMessageDialog(null, mensaje, "Triangulo Rectángulo", JOptionPane.INFORMATION_MESSAGE);
	}
